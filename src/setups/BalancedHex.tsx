...
export const BalancedHexFourPlayer = () => {
  return (
    <Grid viewBox="-59 -63 118 126">
      <>
        ...
        <PlayerTile q={-3} r={2} s={1} />
        <BlueTile q={-3} r={3} s={1} />
...
export const BalancedHexFivePlayer = () => {
  return (
    <Grid viewBox="-59 -63 118 126">
      <>
        {/* Column 1 */}
...
export const BalancedHexSixPlayer = () => {
  return (
    <Grid viewBox="-59 -63 118 126">
      <>
        {/* Column 1 */}
